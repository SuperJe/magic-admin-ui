          ...
          <el-card class="box-card">
            ...
            <div style="overflow-wrap: break-word;">
              ...
              <ul class="list-group list-group-striped" style="overflow-wrap: break-word;">
                ...
                <li>
                  <progress-ball :percent="IntprogressWidth" :course-type="1" :has-signed="hasSigned" :text="progressBallText" :ball-width="ballWidth" style="margin-left: 15%; margin-top: 15%;" />
                </li>
              </ul>
            </div>
          </el-card>
...
import ProgressComponent from './components/python-progress.vue'
...
export default {
  ...
  methods: {
    ...
    getCourse() {
      getCourseDetail(1).then(response => {
        this.course = response.data.detail
      })
    },
    getLearnedRecords() {
      getLearned(1).then(response => {
